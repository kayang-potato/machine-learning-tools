...
class ModelParam():
    ...
    def __init__(self):
        ...
        self.default_search_params = self._default_search_params()
    ...
    def _default_search_params(self):
        ...
        grid_search_params = {
            'DeepLearningRegressor': {
                'hidden_layers': [[1], [1, 0.1], [1, 1, 1], [1, 0.5, 0.1], [2],
                                  [5], [1, 0.5, 0.25, 0.1, 0.05], [1, 1, 1, 1],
                                  [1, 1]],
            ...
            'DeepLearningClassifier': {
                'hidden_layers': [[1], [0.5], [2], [1, 1], [0.5, 0.5], [2, 2],
            ...
            'GradientBoostingRegressor': {
                ...
                'n_estimators':
                [10, 50, 75, 100, 125, 150, 200, 500, 1000, 2000],
            ...
            'LGBMClassifier': {
                ...
                'num_leaves': [
                    2, 4, 7, 10, 15, 20, 25, 30, 35, 40, 50, 65, 80, 100, 125,
                    150, 200, 250
                ],
